...
export const metadata: Metadata = {
  ...
  description: "Browse all product categories at MarketFlow — smartphones, audio, laptops, accessories and more.",
  openGraph: {
    title: "Categories – MarketFlow",
...
export default async function CategoriesPage() {
  ...
  return (
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      <CategoriesHero totalCategories={categories.length} totalProducts={totalProducts} />
